                                ...
                                <div class="col">
                                    <section class="card">
                                        <header class="card-header">
                                            <h2 class="card-title">Farmers List</h2>
                                        </header>
                                        <div class="card-body">
                                                ...
                                                <table class="table table-bordered table-striped mb-0" id="datatable-tabletools">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Farmer Tank Area</th>
                                                            <th>Farmer City</th>
                                                            <th>Farmer Cultivation Volume</th>
                                                            <th>Farmer Old Due</th>
                                                            <th>Edit/Delete</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo $farmer_row['farmerTankArea']; ?></td>
                                                                <td><?php echo $farmer_row['farmerCity']; ?></td>
                                                                <td><?php echo $farmer_row['farmerVolume']; ?></td>
                                                                <td><?php echo $farmer_row['farmerOldDue']; ?></td>
                                                                <td>
                                                                    <form action="add-farmer.php" method="post">
                                                                        <input type="hidden" name="farmerID" value="<?php echo $farmer_row['farmerID']; ?>">
                                                                        <button type="submit" class="btn">
                                                                            <i class="fa fa-pencil-square" aria-hidden="true"></i>
                                                                        </button>
                                                                    </form>
                                                                    <button onclick="farmerDel(<?php echo $farmer_row['farmerID']; ?>);" class="btn">
