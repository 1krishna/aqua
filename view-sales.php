                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo $sale['empName']; ?></td>
                                                                <td><?php echo $sale['farmerName']; ?></td>
                                                                <td><?php echo $sale['productName']; ?></td>
                                                                <td><?php echo $sale['productPrice']; ?></td>
                                                                <td><?php echo $sale['quantity']; ?></td>
                                                                <td><?php echo $sale['totalAmt']; ?></td>
                                                                <td><?php echo $sale['discount']; ?></td>
                                                                <td><?php echo $sale['finalPrice']; ?></td>
                                                                <td>
                                                                    <button onclick="saleDel(<?php echo $sale['saleID']; ?>);" class="btn">
