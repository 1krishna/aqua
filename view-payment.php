                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped mb-0" id="datatable-tabletools">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td><?php echo $payment_row['paymentID']; ?></td>
                                                                <td><?php echo $payment_row['paymentDate']; ?></td>
                                                                <td><?php echo $payment_row['empName']; ?></td>
                                                                <td><?php echo $payment_row['farmerName']; ?></td>
                                                                <td><?php echo $payment_row['paymentAmt']; ?></td>
                                                                <td><?php echo $payment_row['paymentDetails']; ?></td>
                                                                <td>
                                                                    <button onclick="paymentDel(<?php echo $payment_row['paymentID']; ?>);" class="btn">
